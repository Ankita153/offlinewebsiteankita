...
public class ExcelUtility {
	...
	public ArrayList<String> readRow(String filePath, String sheetName, int rowNum) throws Exception{
	...
	public static  HashMap<String, String> readUnameAndPass(String filePath, String sheetName, int unameCol, int passCol) throws Exception{
