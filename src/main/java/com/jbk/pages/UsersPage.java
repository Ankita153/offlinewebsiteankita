...
public class UsersPage extends UserPageRepository {
	...
	public boolean getURLOfBrowser() {
		String exp = "file:///F:/Offline%20Website/Offline%20Website/pages/examples/users.html";
	...
	public boolean getRightCornerHeading() {
		...
		String actual = Utility.getText(homeDashRight);
		if (actual.equals(expected))
			return true;
		else
			return false;
	...
	public boolean verifyAlertMsgForRow1and3DeleteBtn() {//undkl
		ArrayList<String> expData = new ArrayList<String>();
	...
	public boolean verifyAlertMsgForRow2and4DeleteBtn() {//undkl
		ArrayList<String> expData = new ArrayList<String>();
