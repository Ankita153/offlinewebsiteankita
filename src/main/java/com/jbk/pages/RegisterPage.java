...
import com.ObjectRepository.RegisterRepository;

public class RegisterPage extends RegisterRepository {
WebDriver driver;
	...
	public boolean url()
	{
		String expectedUrl = "file:///F:/Offline%20Website/Offline%20Website/pages/examples/register.html" ; 
